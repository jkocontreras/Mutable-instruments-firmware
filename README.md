...
So I wrote a Python script that decodes the WAV directly to a .hex file ready to load with ST-Link and — . No more audio cables, no more failed transfers.
...
— python script to decode any Mutable wav and make a .hex
